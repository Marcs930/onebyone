...
class fudo_widget_syousai extends WP_Widget {
	...
	function form($instance) {
		...
		//v6.1.3
		do_action( 'fudo_syousai_widget_form_pre', $this, $instance );
		...
		<?php
		//v6.1.3
		do_action( 'fudo_syousai_widget_form0', $this, $instance );
		?>
		...
		<?php
		//v6.1.3
		do_action( 'fudo_syousai_widget_form1', $this, $instance );
		//v6.1.3
		do_action( 'fudo_syousai_widget_form2', $this, $instance );
		//v6.1.3
		do_action( 'fudo_syousai_widget_form3', $this, $instance );
		?>
		...
		<?php
		//v6.1.3
		do_action( 'fudo_syousai_widget_form4', $this, $instance );
		?>
		...
		<?php
		//v6.1.3
		do_action( 'fudo_syousai_widget_form5', $this, $instance );
		?>
		...
		<?php
		//v6.1.3
		do_action( 'fudo_syousai_widget_form6', $this, $instance );
		?>
		...
		<?php
		//v6.1.3
		do_action( 'fudo_syousai_widget_form7', $this, $instance );
		?>
		...
		<?php
		//v6.1.3
		do_action( 'fudo_syousai_widget_form8', $this, $instance );
		?>
		...
		<?php
		//v6.1.3
		do_action( 'fudo_syousai_widget_form9', $this, $instance );
		?>
	...
	<?php } ?>
		...
		<?php
		//v6.1.3
		do_action( 'fudo_syousai_widget_form10', $this, $instance );
		?>
	...
	<!-- v5.3.0 -->
		...
		<?php
		//v6.1.3
		do_action( 'fudo_syousai_widget_form11', $this, $instance );
		?>
	...
	<!-- v5.9.0 -->
		...
		<?php
		//v6.1.3
		do_action( 'fudo_syousai_widget_form12', $this, $instance );
		?>
	...
	function update($new_instance, $old_instance) {
		//v6.1.3
		return apply_filters( 'fudo_syousai_widget_form_update', $new_instance, $old_instance );
	}
	...
	function widget($args, $instance) {
		...
		if( $post_ID !='' && $post_type == 'fudo' ){
			...
			if(!empty($metas)) {
				...
				echo '<ul id="'.$args['widget_id'].'_1" class="syousai-content kanren ' . $item_count_class . '">';
				...
				foreach ( $metas as $meta ) {
					 ...
					 * Add $instance
					 */
					do_action( 'fodou_syousai_bukken0', $meta_id, $kaiin, $kaiin2, $instance );
					...
					//v6.1.3
					do_action( 'fodou_syousai_bukken1', $meta_id, $kaiin, $kaiin2, $instance );
				...
				*/
					...
					//v6.1.3
					do_action( 'fodou_syousai_bukken2', $meta_id, $kaiin, $kaiin2, $instance );
					...
					if ( my_custom_kaiin_view('kaiin_kakaku',$kaiin,$kaiin2) ){
						...
						if($view2=="1"){
							...
							//ver6.1.3
							do_action( 'fodou_syousai_bukken_view2a_2', $meta_id, $kaiin, $kaiin2, $instance );
							...
							//ver6.1.3
							do_action( 'fodou_syousai_bukken_view2b_2', $meta_id, $kaiin, $kaiin2, $instance );
						}
					}


					//v6.1.3
					do_action( 'fodou_syousai_bukken3', $meta_id, $kaiin, $kaiin2, $instance );
					...
					if($view3=="1"){
						...
						//ver6.1.3
						do_action( 'fodou_syousai_bukken_view3a_2', $meta_id, $kaiin, $kaiin2, $instance );
						...
						//ver6.1.3
						do_action( 'fodou_syousai_bukken_view3b_2', $meta_id, $kaiin, $kaiin2, $instance );
						...
						//ver6.1.3
						do_action( 'fodou_syousai_bukken_view3c_2', $meta_id, $kaiin, $kaiin2, $instance );

					}


					//v6.1.3
					do_action( 'fodou_syousai_bukken4', $meta_id, $kaiin, $kaiin2, $instance );
					...
					if ( !my_custom_kaiin_view('kaiin_shozaichi',$kaiin,$kaiin2) ){
						...
						if($view4=="1"){
							...
							//ver6.1.3
							do_action( 'fodou_syousai_bukken_view4a_2', $meta_id, $kaiin, $kaiin2, $instance );
							...
							//ver6.1.3
							do_action( 'fodou_syousai_bukken_view4b_2', $meta_id, $kaiin, $kaiin2, $instance );
						}
					}


					//v6.1.3
					do_action( 'fodou_syousai_bukken5', $meta_id, $kaiin, $kaiin2, $instance );
					...
					if ( !my_custom_kaiin_view('kaiin_kotsu',$kaiin,$kaiin2) ){
						...
						if($view5=="1"){
							...
							//ver6.1.3
							do_action( 'fodou_syousai_bukken_view5a_2', $meta_id, $kaiin, $kaiin2, $instance );
							...
							//ver6.1.3
							do_action( 'fodou_syousai_bukken_view5b_2', $meta_id, $kaiin, $kaiin2, $instance );
						}
					}


					//v6.1.3
					do_action( 'fodou_syousai_bukken6', $meta_id, $kaiin, $kaiin2, $instance );

					//v6.1.3
					do_action( 'fodou_syousai_bukken7', $meta_id, $kaiin, $kaiin2, $instance );
					...
					//v6.1.3
					do_action( 'fodou_syousai_bukken8', $meta_id, $kaiin, $kaiin2, $instance );
					...
					//v6.1.3
					do_action( 'fodou_syousai_bukken9', $meta_id, $kaiin, $kaiin2, $instance );
