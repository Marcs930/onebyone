 ...
 *
 * Template: single-fudo2023.php
 *
 * @package WordPress6.1
 * @subpackage Fudousan Plugin
 * @subpackage Twenty Twenty-Three
 * Version: 6.1.1
 */
	...
	//FSEヘッダー Twenty Twenty-Three ver1.0.0 header.html
	...
	//FSEフッター Twenty Twenty-Three ver1.0.0 footer.html
...
<?php
	...
	$single_fudo_page_content = fudou_gutenberg_get_the_template_html( $buffer );


//end  single_fudo_page_content Pre
...
<?php
	/*
	 * single_fudo_page_content
	 * v6.1.1
	 */
	echo $single_fudo_page_content;
?>
<?php wp_footer(); ?>
</div><!-- .wp-site-blocks -->
<!-- Template v6.1.1 -->
